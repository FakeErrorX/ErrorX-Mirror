...
<body>
  <!--© Designed and coded by ErrorX-->
    <header>
      ...
      <div class="social">
        <a href="https://www.github.com/FakeErrorX"><i class="fab fa-github"></i></a>
        <a href="https://t.me/ErrorX_BD"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
<body>
   <!--© Designed and coded by ErrorX-->
    <header>
      ...
      <div class="social">
        <a href="https://www.github.com/FakeErrorX"><i class="fab fa-github"></i></a>
        <a href="https://t.me/ErrorX_BDd"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
